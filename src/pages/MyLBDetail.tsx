        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            >
              ...
              <br />
              SiteWeb :
              <a href="https://my-lb-make-your-life-better.vercel.app" className="text-primary hover:underline">
                MyLb
              </a>
            </motion.p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="glass-card p-6 bg-foreground/5 border-border/50">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  ...
                  <br /><br />
                  <span className="text-foreground font-mono bg-foreground/10 px-2 py-0.5 rounded">XSS</span> - Prévention des scripts malicieux.
                  <br />
                  <span className="text-foreground font-mono bg-foreground/10 px-2 py-0.5 rounded">CSRF</span> - Protection des requêtes cross-site.
                  <br />
                  <span className="text-foreground font-mono bg-foreground/10 px-2 py-0.5 rounded">SQLi</span> - Sécurisation totale des accès MySQL.
                </p>
              </div>
            </div>
          </motion.div>
