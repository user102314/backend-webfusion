      ...
      <main className="pt-32 pb-24 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            <br />
            SiteWeb :
            <a href="https://webfusiondigital.tn" className="text-primary hover:underline">WebFusionDigital</a>
          </div>
          ...
          <div className="mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <motion.div whileHover={{ y: -10 }} className="group relative rounded-2xl overflow-hidden border border-border/50 aspect-video">
                <img src="/w1.webp" alt="Cybersecurity" className="w-full h-full object-cover" />
              ...
              <motion.div whileHover={{ y: -10 }} className="group relative rounded-2xl overflow-hidden border border-border/50 aspect-video">
                <img src="/w2.webp" alt="Web App" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent" />
              ...
              <motion.div whileHover={{ y: -10 }} className="group relative rounded-2xl overflow-hidden border border-border/50 aspect-video">
                <img src="/w3.webp" alt="Complex Systems" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent" />
